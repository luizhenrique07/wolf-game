      ...
      <View style={styles.container}>
        ...
        >
          <Text style={styles.continueBtnText}>
            {isLastPlayer ? 'Begin Night 🌙' : 'Done — pass to next player →'}
          </Text>
        </Pressable>
      </View>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  container: { flex: 1, alignItems: 'center', paddingHorizontal: 24, paddingVertical: 32, gap: 16 },
  heading: { fontSize: 13, color: '#5A3A8A', textTransform: 'uppercase', letterSpacing: 2 },
